...
if not check_internet_connection():
    ...
    sys.exit(1) 
if chon == 1.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/tdstiktok.py').text)

if chon == 1.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/tdsfb.py').text)
if chon == 1.3 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/tdspage.py').text)
if chon == 2.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/ttcpage.py').text)
if chon == 3.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/goliketiktokauto.py').text)
if chon == 3.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/obf-golike.py').text)
if chon == 5.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/cmtdaofb.py').text)
if chon == 5.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/regpage.py').text)
if chon == 5.3 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/buffpage.py').text)
if chon == 5.4 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/chuyenquyenqtv.py').text)
if chon == 5.5 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/cmtfb.py').text)
if chon == 5.6 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/spambox.py').text)
if chon == 5.7 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/spammess.py').text)

if chon == 5.9 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/mailfb.py').text)
if chon == 5.11 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/getcookie.py').text)
if chon == 5.12 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/nuoifb.py').text)
if chon == 5.13 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/gettoken.py').text)
if chon == 5.14 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/cmtpage.py').text)
if chon == 5.15 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/id.py').text)
if chon == 5.16 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/chuinhau.py').text)
if chon == 5.17 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/checkthongtinfb.py').text)
if chon == 5.18 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/cookiepro5.py').text)
if chon == 5.19 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/shareao.py').text)
if chon == 5.21 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/shareaodaluong.py').text)
if chon == 5.22 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/shareaotoken.py').text)
if chon == 5.23 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/tocao.py').text)
if chon == 6.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/sms.py').text)
if chon == 6.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/viewprx.txt').text)
if chon == 6.3 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/zefoy.py').text)
if chon == 6.4 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/zefoylong.py').text)
if chon == 7.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/mail.txt').text)
if chon == 7.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/timproxy.txt').text)
if chon == 7.3 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/locproxy.txt').text)
##van longg
if chon == 8.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/hdt.py').text)

	
#tool kiếm xu
if chon == 9.1 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/kramer-specter_deobf/main/kramer-specter-deobf.py').text)
if chon == 9.2 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/pyc.txt').text)
if chon == 555 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/1234/main/ham.txt').text)
if chon == 666 :
	exec(requests.get('https://raw.githubusercontent.com/Duy4049999/123/main/666.py').text)
else :
	exit()
